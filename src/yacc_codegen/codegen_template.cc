...
#include <yacc_codegen/codegen_impl.h>
 ...
 */
typeof(__{{ prefix }}__t_.{{ start_type }}) {{ prefix }}_parse_len(int context, void* error_ctx, void* buffers_, const char* input, uint32_t input_len);
typeof(__{{ prefix }}__t_.{{ start_type }}) {{ prefix }}_parse(int context, void* error_ctx, void* buffers_, const char* input);
...
typeof(__{{ prefix }}__t_.{{ start_type }}) {{ prefix }}_parse_len(int context, void* error_ctx, void* buffers_, const char* input, uint32_t input_len)
{
    NeoastInput* lexer_input = input_new_from_buffer(context, input, input_len);
...
typeof(__{{ prefix }}__t_.{{ start_type }}) {{ prefix }}_parse(int context, void* error_ctx, void* buffers_, const char* input)
{
    return {{ prefix }}_parse_len(context, error_ctx, buffers_, input, strlen(input));
}
